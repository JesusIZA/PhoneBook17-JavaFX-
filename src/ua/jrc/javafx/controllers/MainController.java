package ua.jrc.javafx.controllers;
...
import ua.jrc.javafx.interfaces.impls.CollectionAddressBook;
import ua.jrc.javafx.objects.Person;
import ua.jrc.javafx.utils.DialogManager;
...
public class MainController implements Initializable {
    ...
    private void initLoader() {
        try {
            ...
            fxmlLoader.setResources(ResourceBundle.getBundle("ua.jrc.javafx.bundles.Locale", new Locale("ru")));
