...
import ua.jrc.javafx.controllers.MainController;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        fxmlLoader.setResources(ResourceBundle.getBundle("ua.jrc.javafx.bundles.Locale"));
